...
category_path = "/computer-parts-compnents/cases.html"
...
def scrape(export_dir):
    ...
    if product_data:
        ...
        filename = export_dir / f"gccgamers_cases_{date.today().isoformat()}.csv"
        ...
        print(f"\n✅ Scraped {len(product_data)} case products. Saved to {filename}")
    else:
